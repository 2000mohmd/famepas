...
serve(async (req) => {
  ...
  try {
    ...
    const { email, password, role, venue_name, venue_category, venue_city } = await req.json();
    ...
    const { data: newUser, error: createError } = await supabaseAdmin.auth.admin.createUser({
      ...
      password,
      email_confirm: true,
      user_metadata: { full_name: venue_name ? `${venue_name} Owner` : email },
    });
    ...
    // If venue role, create venue record
    let venue = null;
